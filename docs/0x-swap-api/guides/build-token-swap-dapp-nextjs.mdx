...
PriceView displays indicative pricing using[/swap/allowance-holder/price](/api#tag/Swap/operation/swap::allowanceHolder::getPrice). Indicative pricing is for users to browse for a price without committing to a trade.
