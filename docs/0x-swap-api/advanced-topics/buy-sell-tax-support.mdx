...
```mdx-code-block
import GenericSwapError from '/static/img/0x-swap-api/generic-swap-error.png';
...
```mdx-code-block
import MatchaBuyTaxUI from '/static/img/0x-swap-api/matcha-buy-tax-ui.png';
...
```mdx-code-block
import MatchaBuySellTaxUI from '/static/img/0x-swap-api/matcha-buy-sell-tax-ui.png';
...
```mdx-code-block
import MatchaTransferFeeInfo from '/static/img/0x-swap-api/matcha-transfer-fee-info.png';
