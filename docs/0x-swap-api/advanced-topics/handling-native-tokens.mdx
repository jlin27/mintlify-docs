---
title: "Handling Native Tokens with 0x Swap API"
sidebarTitle: "Handling Native Tokens"
description: "When using the 0x Swap API to handle native tokens like ETH, the process differs from ERC-20 tokens. This guide explains how to manage native tokens properly and provides context on their representation in the blockchain ecosystem"
---
...
See a full [Swap API headless example](https://github.com/0xProject/0x-examples/blob/main/swap-v2-headless-example/index.ts) that demonstrates how to handle native tokens. See the running instructions [here](https://github.com/0xProject/0x-examples/tree/main/swap-v2-headless-example).
</Tip>
...
## Wrapping and Unwrapping between ETH and WETH[​](https://0x.org/docs/0x-swap-api/advanced-topics/#wrapping-and-unwrapping-between-eth-and-weth "Direct link to Wrapping and Unwrapping between ETH and WETH")
