---
title: "getQuote (Allowance Holder)"
description: "Get the firm quote for a swap using Allowance Holder to set allowances"
api: GET https://api.0x.org/swap/allowance-holder/quote
...
<ResponseField name="txOrigin" type="string">
...
<ResponseField name="swapFeeRecipient" type="string">
...
<ResponseField name="swapFeeBps" type="integer">
...
<ResponseField name="swapFeeToken" type="string">
...
<ResponseField name="tradeSurplusRecipient" type="string">
...
<ResponseField name="slippageBps" type="integer">
...
<ResponseField name="excludedSources" type="string">
...
<ResponseField name="sellEntireBalance" type="string">
...
<ResponseField name="0x-api-key" type="string" required>
Visit dashboard.0x.org to get your API Key
</ResponseField>

<ResponseField name="0x-version" type="string" required>
API version
Example: v2
</ResponseField>
...
<ResponseField name="allowanceTarget" type="string or null" required>
...
<ResponseField name="totalNetworkFee" type="string or null" required>
