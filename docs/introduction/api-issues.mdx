...
2. [**Error codes**](/docs/introduction/api-issues#error-codes): These are returned when there is an issue making the API request itself, such as invalid input or authorization errors.

---

## Issues Object

By examining both the [`issues` object](/api-reference/swap/getprice-allowance-holder) for quote validation and the error codes for request failures, developers can troubleshoot and resolve issues more efficiently, ensuring smoother transaction processes.
